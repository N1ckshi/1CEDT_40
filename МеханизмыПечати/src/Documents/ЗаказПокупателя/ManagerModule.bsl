...
// СтрокаТаблицыЗначений, Неопределено - Описание созданной команды для подключения в список команд.
//
Функция ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
    ...
    Возврат КомандыСозданияНаОсновании;
	
КонецФункции
// Определяет настройки печати объекта.
//
// Параметры:
...
// КоллекцияПечатныхФорм - ТаблицаЗначений - печатные формы.
// ОбъектыПечати - СписокЗначений Из ДокументСсылка.ЗаказПокупателя - значение - ссылка на объект;
